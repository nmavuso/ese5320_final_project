...
HD_PWD='/mnt/castor/seas_home/a/abdellah/Documents/ese5320_final_project/_x/link/vivado/vpl/prj/prj.runs/u96v2_sbc_base_s02_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u96v2_sbc_base_s02_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u96v2_sbc_base_s02_regslice_0.tcl
