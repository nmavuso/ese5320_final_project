...
-- 0x44 : reserved
-- 0x48 : Data signal of output_length
--        bit 31~0 - output_length[31:0] (Read/Write)
-- 0x4c : Data signal of output_length
...
architecture behave of lzw_fpga_control_s_axi is
    ...
    constant ADDR_INPUT_SIZE_DATA_0    : INTEGER := 16#1c#;
    constant ADDR_INPUT_SIZE_CTRL      : INTEGER := 16#20#;
    ...
    constant ADDR_OUTPUT_LENGTH_DATA_0 : INTEGER := 16#48#;
    constant ADDR_OUTPUT_LENGTH_DATA_1 : INTEGER := 16#4c#;
    constant ADDR_OUTPUT_LENGTH_CTRL   : INTEGER := 16#50#;
    ...
    signal int_input_size      : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_INPUT_SIZE_DATA_0 =>
                        rdata_data <= RESIZE(int_input_size(31 downto 0), 32);
                    when ADDR_OUTPUT_CODE_DATA_0 =>
                        rdata_data <= RESIZE(int_output_code(31 downto 0), 32);
                    when ADDR_OUTPUT_CODE_DATA_1 =>
                        rdata_data <= RESIZE(int_output_code(63 downto 32), 32);
                    when ADDR_OUTPUT_SIZE_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    input_size           <= STD_LOGIC_VECTOR(int_input_size);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUT_SIZE_DATA_0) then
                    int_input_size(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_input_size(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_CODE_DATA_0) then
                    int_output_code(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_output_code(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_CODE_DATA_1) then
                    int_output_code(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_output_code(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_SIZE_DATA_0) then
                    int_output_size(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_output_size(31 downto 0));
                end if;
            end if;
        end if;
    end process;
