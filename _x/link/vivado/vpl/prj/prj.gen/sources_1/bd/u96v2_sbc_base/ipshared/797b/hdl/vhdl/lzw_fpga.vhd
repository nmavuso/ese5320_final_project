...
architecture behav of lzw_fpga is 
    ...
    "lzw_fpga_lzw_fpga,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.866910,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=74,HLS_SYN_DSP=0,HLS_SYN_FF=4724,HLS_SYN_LUT=9833,HLS_VERSION=2020_2}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal grp_encoding_fu_104_ap_ext_blocking_n : STD_LOGIC;
    signal grp_encoding_fu_104_ap_str_blocking_n : STD_LOGIC;
    signal grp_encoding_fu_104_ap_int_blocking_n : STD_LOGIC;
    ...
    signal grp_decoding_fu_116_ap_ext_blocking_n : STD_LOGIC;
    signal grp_decoding_fu_116_ap_str_blocking_n : STD_LOGIC;
    signal grp_decoding_fu_116_ap_int_blocking_n : STD_LOGIC;
...
begin
    ...
    ap_sub_ext_blocking_0_assign_proc : process(grp_encoding_fu_104_ap_ext_blocking_n)
    begin
        if ((grp_encoding_fu_104_ap_ext_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_ext_blocking_1_assign_proc : process(grp_decoding_fu_116_ap_ext_blocking_n)
    begin
        if ((grp_decoding_fu_116_ap_ext_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_int_blocking_0_assign_proc : process(grp_encoding_fu_104_ap_int_blocking_n)
    begin
        if ((grp_encoding_fu_104_ap_int_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_int_blocking_1_assign_proc : process(grp_decoding_fu_116_ap_int_blocking_n)
    begin
        if ((grp_decoding_fu_116_ap_int_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_str_blocking_0_assign_proc : process(grp_encoding_fu_104_ap_str_blocking_n)
    begin
        if ((grp_encoding_fu_104_ap_str_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_str_blocking_1_assign_proc : process(grp_decoding_fu_116_ap_str_blocking_n)
    begin
        if ((grp_decoding_fu_116_ap_str_blocking_n = ap_const_logic_0)) then 
    ...
    begin
        if ((ap_ST_fsm_state75 = ap_CS_fsm)) then 
