...
set_property -dict [ list  \
  ...
  CONFIG.S03_HAS_DATA_FIFO {2}  ] $axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /lzw_fpga_1/s_axi_control] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /lzw_fpga_1/m_axi_gmem0] \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S00_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /lzw_fpga_1/m_axi_gmem1] \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S01_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /lzw_fpga_1/m_axi_gmem] \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S02_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /lzw_fpga_1/m_axi_gmem2] \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S03_AXI] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /lzw_fpga_1/ap_clk] \
  ...
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S02_ACLK] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S03_ACLK] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S02_ARESETN] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S03_ARESETN] \

connect_bd_net  \
  [get_bd_pins -auto_enable /proc_sys_reset_0/peripheral_aresetn] \
  [get_bd_pins -auto_enable /lzw_fpga_1/ap_rst_n] \
...
connect_bd_net  \
  [get_bd_pins -auto_enable /lzw_fpga_1/interrupt] \
