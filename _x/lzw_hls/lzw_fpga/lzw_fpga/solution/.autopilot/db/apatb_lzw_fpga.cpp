...
// wrapc file define:
#define AUTOTB_TVIN_s "../tv/cdatafile/c.lzw_fpga.autotvin_s.dat"
#define AUTOTB_TVOUT_s "../tv/cdatafile/c.lzw_fpga.autotvout_s.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_s "../tv/rtldatafile/rtl.lzw_fpga.autotvout_s.dat"
// tvout file define:
...
extern "C" void lzw_fpga_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *);

extern "C" void apatb_lzw_fpga_hw(volatile void * __xlx_apatb_param_s, volatile void * __xlx_apatb_param_output_code, volatile void * __xlx_apatb_param_output_size, volatile void * __xlx_apatb_param_output) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {{
            ...
            ((int*)__xlx_apatb_param_s)[j] = gmem_pc_buffer[i].to_int64();
          }
            for (int j = 0, e = 1; j < e; j += 1, ++i) {
            ((int*)__xlx_apatb_param_output_code)[j] = gmem_pc_buffer[i].to_int64();
          }
            for (int j = 0, e = 1; j < e; j += 1, ++i) {
...
// print gmem Transactions
{
  ...
  {  __xlx_offset_byte_param_s = 0*4;
  if (__xlx_apatb_param_s) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_s)[j];

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_gmem, __xlx_sprintf_buffer.data()); 
      }
  }
  __xlx_offset_byte_param_output_code = 1*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_output_code)[j];
  ...
  __xlx_offset_byte_param_output_size = 2*4;
...
// print s Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_s;
...
lzw_fpga_hw_stub_wrapper(__xlx_apatb_param_s, __xlx_apatb_param_output_code, __xlx_apatb_param_output_size, __xlx_apatb_param_output);
