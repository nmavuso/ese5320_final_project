; ModuleID = '/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/_x/lzw_hls/lzw_fpga/lzw_fpga/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_lzw_fpga_ir(i8* %s, i32* %output_code, i32* %output_size, i8* %output) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_lzw_fpga_hw(i8* %s_copy, i32* %output_code_copy, i32* %output_size_copy, i8* %output_copy)
...
declare void @apatb_lzw_fpga_hw(i8*, i32*, i32*, i8*)

define void @lzw_fpga_hw_stub_wrapper(i8*, i32*, i32*, i8*) #5 {
entry:
  call void @copy_out(i8* null, i8* %0, i32* null, i32* %1, i32* null, i32* %2, i8* null, i8* %3)
  call void @lzw_fpga_hw_stub(i8* %0, i32* %1, i32* %2, i8* %3)
  call void @copy_in(i8* null, i8* %0, i32* null, i32* %1, i32* null, i32* %2, i8* null, i8* %3)
  ret void
}

declare void @lzw_fpga_hw_stub(i8*, i32*, i32*, i8*)
