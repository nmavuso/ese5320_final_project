# 1 "/mnt/castor/seas_home/j/joaquinr/ese5320_final_project/hls/lzw_hls.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 314 "/mnt/pollux/software/xilinx/2020.2/Vitis_HLS/2020.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 2 "<built-in>" 2
# 1 "/mnt/castor/seas_home/j/joaquinr/ese5320_final_project/hls/lzw_hls.c" 2
...
# 2 "/mnt/castor/seas_home/j/joaquinr/ese5320_final_project/hls/lzw_hls.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 3 "/mnt/castor/seas_home/j/joaquinr/ese5320_final_project/hls/lzw_hls.c" 2
...
int encoding(const char *s, int *output_code, int *output_size) {
    ...
    VITIS_LOOP_35_2: for (int i = 1; s[i] != '\0'; i++) {
        char c[2] = {s[i], '\0'};
        char temp[256];
        ...
        int found = -1;
        VITIS_LOOP_42_3: for (int j = 0; j < table_size; j++) {
        ...
        if (found != -1) {
            ...
            VITIS_LOOP_53_4: for (int j = 0; j < table_size; j++) {
    ...
    VITIS_LOOP_71_5: for (int j = 0; j < table_size; j++) {
        if (strcmp(table[j].str, p) == 0) {
            output_code[out_index++] = table[j].code;
            break;
        }
...
int decoding(const int *encoded_data, int encoded_size) {
    DecodeEntry table[4096];
    int table_size = 256;


    VITIS_LOOP_87_1: for (int i = 0; i < 256; i++) {
        table[i].code = i;
        table[i].str[0] = (char)i;
        table[i].str[1] = '\0';
    }
    ...
    VITIS_LOOP_98_2: for (int i = 1; i < encoded_size; i++) {
...
__attribute__((sdx_kernel("lzw_fpga", 0))) void lzw_fpga (const char *s, int *output_code, int *output_size, const int *encoded_data, int encoded_size) {
#pragma HLS TOP name=lzw_fpga
# 122 "/mnt/castor/seas_home/j/joaquinr/ese5320_final_project/hls/lzw_hls.c"
