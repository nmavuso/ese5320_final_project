# 1 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp" 2
# 353 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp"
...
# 354 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp" 2
# 1 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.h" 1
...
# 5 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.h" 2
...
# 355 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp" 2
# 366 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp"
void string_copy(char *dest, const char *src, int max_len) {
    int i = 0;
    VITIS_LOOP_368_1: for (i = 0; i < max_len - 1 && src[i] != '\0'; i++) {
        dest[i] = src[i];
    }
    dest[i] = '\0';
}
...
int string_compare(const char *s1, const char *s2) {
    int i = 0;
    VITIS_LOOP_377_1: while (s1[i] != '\0' && s2[i] != '\0') {
        if (s1[i] != s2[i]) {
            return s1[i] - s2[i];
        }
        i++;
...
int string_length(const char *str) {
    int len = 0;
    VITIS_LOOP_389_1: while (str[len] != '\0' && len < 1024) {
        len++;
    }
    return len;
}
...
void encoding(const char *input, int *output_code, int *output_size) {
    ...
    VITIS_LOOP_402_1: for (int i = 0; i <= 256; i++) {
    ...
    VITIS_LOOP_411_2: for (int i = 1; input[i] != '\0'; i++) {
        char c = input[i];
        char temp[1024];
        ...
        int found = -1;
        VITIS_LOOP_423_3: for (int j = 0; j < table_size; j++) {
        ...
        if (found != -1) {
            ...
            VITIS_LOOP_435_4: for (int j = 0; j < table_size; j++) {
    ...
    VITIS_LOOP_456_5: for (int j = 0; j < table_size; j++) {
        if (string_compare(p, table[j].str) == 0) {
            output_code[out_index++] = table[j].code;
            break;
        }
...
void decoding(const int *encoded_data, int encoded_size, char *output) {
    ...
    VITIS_LOOP_472_1: for (int i = 0; i <= 256; i++) {
        table[i].str[0] = (char)i;
        table[i].str[1] = '\0';
        table[i].code = i;
    }
    ...
    string_copy(output, table[old_code].str, 1024);
    output_index += string_length(table[old_code].str);
    char c = table[old_code].str[0];

    VITIS_LOOP_486_2: for (int i = 1; i < encoded_size; i++) {
        ...
        if (new_code >= table_size) {
            int k = 0;
            VITIS_LOOP_493_3: while (table[old_code].str[k] != '\0') {
            ...
            string_copy(entry, table[new_code].str, 1024);
        }


        int k = 0;
        VITIS_LOOP_505_4: while (entry[k] != '\0') {
            output[output_index++] = entry[k++];
        }


        if (table_size < 4096) {
            string_copy(table[table_size].str, table[old_code].str, 1024);
...
# 528 "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp"
