...
set C_modelArgList {
	...
	{ local_output int 8 regular {array 256 { 1 3 } 1 1 }  }
	{ output_r int 64 regular {fifo 0}  }
	{ output_length int 9 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_output", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "output_r", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "output_length", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_output_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_output", "role": "q0" }} , 
 	...
 	{ "name": "output_length", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "output_length", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "local_output", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "output_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "7", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "output_length", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "1"}]}]}
...
set Spec2ImplPortList { 
	...
	local_output { ap_memory {  { local_output_address0 mem_address 1 8 }  { local_output_ce0 mem_ce 1 1 }  { local_output_q0 mem_dout 0 8 } } }
	output_r { ap_fifo {  { output_r_dout fifo_data 0 64 }  { output_r_empty_n fifo_status 0 1 }  { output_r_read fifo_update 1 1 } } }
	output_length { ap_none {  { output_length in_data 0 9 } } }
}
