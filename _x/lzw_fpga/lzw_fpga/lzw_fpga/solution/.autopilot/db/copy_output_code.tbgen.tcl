set moduleName copy_output_code
set isTopModule 0
...
set C_modelName {copy_output_code}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 1}  }
	{ local_output_code int 32 regular {array 256 { 1 3 } 1 1 }  }
	{ output_code int 64 regular {fifo 0}  }
	{ local_output_size int 32 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_output_code", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "output_code", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ local_output_code_address0 sc_out sc_lv 8 signal 1 } 
	{ local_output_code_ce0 sc_out sc_logic 1 signal 1 } 
	{ local_output_code_q0 sc_in sc_lv 32 signal 1 } 
	{ output_code_dout sc_in sc_lv 64 signal 2 } 
	{ output_code_empty_n sc_in sc_logic 1 signal 2 } 
	{ output_code_read sc_out sc_logic 1 signal 2 } 
	{ local_output_size_dout sc_in sc_lv 32 signal 3 } 
	{ local_output_size_empty_n sc_in sc_logic 1 signal 3 } 
	{ local_output_size_read sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_output_code_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "local_output_code", "role": "q0" }} , 
 	{ "name": "output_code_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_code", "role": "dout" }} , 
 	{ "name": "output_code_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_code", "role": "empty_n" }} , 
 	{ "name": "output_code_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_code", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "local_output_code", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "output_code", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	local_output_code { ap_memory {  { local_output_code_address0 mem_address 1 8 }  { local_output_code_ce0 mem_ce 1 1 }  { local_output_code_q0 mem_dout 0 32 } } }
	output_code { ap_fifo {  { output_code_dout fifo_data 0 64 }  { output_code_empty_n fifo_status 0 1 }  { output_code_read fifo_update 1 1 } } }
