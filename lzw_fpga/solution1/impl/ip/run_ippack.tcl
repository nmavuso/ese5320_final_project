...
set solution_dir "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/lzw_fpga/solution1"
set debug_dir "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/lzw_fpga/solution1/.debug"
set xo_hls_files_dir "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/lzw_fpga/solution1/impl/ip/hls_files"
set hdl_module_list {lzw_fpga_encoding_table_str
...
set kernel_xo "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/lzw_fpga/solution1/impl/export.xo"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 s_1 W 0x0 "Data signal of s" {{0 32 s W 0 "Bit 31 to 0 of s"}}} {0x14 s_2 W 0x0 "Data signal of s" {{0 32 s W 0 "Bit 63 to 32 of s"}}} {0x1c output_code_1 W 0x0 "Data signal of output_code" {{0 32 output_code W 0 "Bit 31 to 0 of output_code"}}} {0x20 output_code_2 W 0x0 "Data signal of output_code" {{0 32 output_code W 0 "Bit 63 to 32 of output_code"}}} {0x28 output_size_1 W 0x0 "Data signal of output_size" {{0 32 output_size W 0 "Bit 31 to 0 of output_size"}}} {0x2c output_size_2 W 0x0 "Data signal of output_size" {{0 32 output_size W 0 "Bit 63 to 32 of output_size"}}} {0x34 output_r_1 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 31 to 0 of output_r"}}} {0x38 output_r_2 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 63 to 32 of output_r"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
