...
extern "C" void lzw_fpga(int*, int, int, int, int);
extern "C" void apatb_lzw_fpga_hw(volatile void * __xlx_apatb_param_s, volatile void * __xlx_apatb_param_output_code, volatile void * __xlx_apatb_param_output_size, volatile void * __xlx_apatb_param_output) {
  ...
  // DUT call
  lzw_fpga(__xlx_s_output_code_output_size_output__input_buffer, __xlx_offset_byte_param_s, __xlx_offset_byte_param_output_code, __xlx_offset_byte_param_output_size, __xlx_offset_byte_param_output);
