...
set C_modelArgList {
	{ dest int 8 regular {array 256 { 0 3 } 0 1 }  }
	{ src int 8 regular {array 131072 { 1 3 } 1 1 }  }
	{ src_offset int 9 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dest", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "src", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "src_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dest_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "dest", "role": "address0" }} , 
 	...
 	{ "name": "src_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "src", "role": "address0" }} , 
 	...
 	{ "name": "src_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "src_offset", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5", "Max" : "513"}
	, {"Name" : "Interval", "Min" : "5", "Max" : "513"}
]}
...
set Spec2ImplPortList { 
	dest { ap_memory {  { dest_address0 mem_address 1 8 }  { dest_ce0 mem_ce 1 1 }  { dest_we0 mem_we 1 1 }  { dest_d0 mem_din 1 8 } } }
	src { ap_memory {  { src_address0 mem_address 1 17 }  { src_ce0 mem_ce 1 1 }  { src_q0 mem_dout 0 8 } } }
	src_offset { ap_none {  { src_offset in_data 0 9 } } }
}
