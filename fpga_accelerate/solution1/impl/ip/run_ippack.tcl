...
set IPName      "lzw_fpga"
set Version     "1.0"
set DisplayName "Lzw_fpga"
set Revision    "2113844549"
...
set xo_kernel_name "lzw_fpga"
set xo_kernel_files {/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/hls/lzw_hls.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/fpga_accelerate/solution1"
set debug_dir "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/fpga_accelerate/solution1/.debug"
set xo_hls_files_dir "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/fpga_accelerate/solution1/impl/ip/hls_files"
set hdl_module_list {lzw_fpga_mux_464_32_1_1
lzw_fpga_mux_464_8_1_1
lzw_fpga_encoding_table_prefix_code_0
lzw_fpga_encoding_table_character_0
lzw_fpga_mux_432_8_1_1
lzw_fpga_mux_432_32_1_1
lzw_fpga_mux_164_8_1_1
lzw_fpga_decoding_table_prefix_code_0
lzw_fpga_decoding_table_character_0
lzw_fpga_fifo_w64_d2_S
lzw_fpga_fifo_w32_d2_S
lzw_fpga_fifo_w32_d3_S
lzw_fpga_fifo_w64_d4_S
lzw_fpga_fifo_w64_d7_S
lzw_fpga_fifo_w64_d7_S
lzw_fpga_fifo_w64_d7_S
lzw_fpga_fifo_w8_d16_S
lzw_fpga_fifo_w32_d16_S
lzw_fpga_fifo_w32_d2_S
lzw_fpga_fifo_w32_d2_S
lzw_fpga_fifo_w8_d16_S
lzw_fpga_fifo_w32_d4_S
lzw_fpga_fifo_w9_d2_S
lzw_fpga_fifo_w9_d2_S
lzw_fpga_fifo_w32_d2_S
lzw_fpga_start_for_encoding_U0
lzw_fpga_start_for_decoding_U0
lzw_fpga_start_for_store_output_U0
lzw_fpga_start_for_Block_split212_proc_U0
lzw_fpga_control_s_axi
lzw_fpga_gmem0_m_axi
lzw_fpga_gmem1_m_axi
lzw_fpga_gmem_m_axi
lzw_fpga_gmem2_m_axi
lzw_fpga_entry11
load_input
encoding
decoding
...
set kernel_xo "/mnt/castor/seas_home/n/nmavuso/ese5320_final_project/lzw_fpga.xo"

## Variables
set Top "lzw_fpga"
set TopNoPrefix "lzw_fpga"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 input_r_1 W 0x0 "Data signal of input_r" {{0 32 input_r W 0 "Bit 31 to 0 of input_r"}}} {0x14 input_r_2 W 0x0 "Data signal of input_r" {{0 32 input_r W 0 "Bit 63 to 32 of input_r"}}} {0x1c input_size W 0x0 "Data signal of input_size" {{0 32 input_size W 0 "Bit 31 to 0 of input_size"}}} {0x24 output_code_1 W 0x0 "Data signal of output_code" {{0 32 output_code W 0 "Bit 31 to 0 of output_code"}}} {0x28 output_code_2 W 0x0 "Data signal of output_code" {{0 32 output_code W 0 "Bit 63 to 32 of output_code"}}} {0x30 output_size_1 W 0x0 "Data signal of output_size" {{0 32 output_size W 0 "Bit 31 to 0 of output_size"}}} {0x34 output_size_2 W 0x0 "Data signal of output_size" {{0 32 output_size W 0 "Bit 63 to 32 of output_size"}}} {0x3c output_r_1 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 31 to 0 of output_r"}}} {0x40 output_r_2 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 63 to 32 of output_r"}}} {0x48 output_length_1 W 0x0 "Data signal of output_length" {{0 32 output_length W 0 "Bit 31 to 0 of output_length"}}} {0x4c output_length_2 W 0x0 "Data signal of output_length" {{0 32 output_length W 0 "Bit 63 to 32 of output_length"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 m_axi_gmem1 m_axi_gmem m_axi_gmem2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 6.7 machine 64 combinational 0 latency undef II x}
...
source -notrace "/mnt/pollux/software/xilinx/2020.2/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"
