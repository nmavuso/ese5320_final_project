...
architecture behav of lzw_fpga_load_input is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln159_1_reg_157 : STD_LOGIC_VECTOR (0 downto 0);
    signal input_stream_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal icmp_ln159_1_reg_157_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal input_r_blk_n : STD_LOGIC;
    signal input_size_blk_n : STD_LOGIC;
    signal i_reg_94 : STD_LOGIC_VECTOR (30 downto 0);
    signal input_size_read_reg_131 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln159_fu_105_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem0_addr_reg_141 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln159_fu_117_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln159_reg_147 : STD_LOGIC_VECTOR (30 downto 0);
    signal add_ln159_fu_120_p2 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal icmp_ln159_1_fu_126_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem0_addr_read_reg_161 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
                i_reg_94 <= ap_const_lv31_0;
            elsif (((icmp_ln159_1_fu_126_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_reg_94 <= add_ln159_fu_120_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln159_1_reg_157 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                gmem0_addr_read_reg_161 <= m_axi_gmem0_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln159_fu_105_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                gmem0_addr_reg_141 <= input_r_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln159_1_reg_157 <= icmp_ln159_1_fu_126_p2;
                icmp_ln159_1_reg_157_pp0_iter1_reg <= icmp_ln159_1_reg_157;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                input_size_read_reg_131 <= input_size_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                trunc_ln159_reg_147 <= trunc_ln159_fu_117_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_ARREADY, input_r_empty_n, input_size_empty_n, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln159_fu_105_p2, ap_enable_reg_pp0_iter0, icmp_ln159_1_fu_126_p2, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_size_empty_n = ap_const_logic_0) or (input_r_empty_n = ap_const_logic_0))) and (icmp_ln159_fu_105_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state75;
                elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_size_empty_n = ap_const_logic_0) or (input_r_empty_n = ap_const_logic_0))) and (icmp_ln159_fu_105_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    add_ln159_fu_120_p2 <= std_logic_vector(unsigned(i_reg_94) + unsigned(ap_const_lv31_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_gmem0_RVALID, input_stream_full_n, ap_enable_reg_pp0_iter1, icmp_ln159_1_reg_157, ap_enable_reg_pp0_iter2, icmp_ln159_1_reg_157_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln159_1_reg_157_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (input_stream_full_n = ap_const_logic_0)) or ((icmp_ln159_1_reg_157 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem0_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_gmem0_RVALID, input_stream_full_n, ap_enable_reg_pp0_iter1, icmp_ln159_1_reg_157, ap_enable_reg_pp0_iter2, icmp_ln159_1_reg_157_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln159_1_reg_157_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (input_stream_full_n = ap_const_logic_0)) or ((icmp_ln159_1_reg_157 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem0_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_gmem0_RVALID, input_stream_full_n, ap_enable_reg_pp0_iter1, icmp_ln159_1_reg_157, ap_enable_reg_pp0_iter2, icmp_ln159_1_reg_157_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln159_1_reg_157_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (input_stream_full_n = ap_const_logic_0)) or ((icmp_ln159_1_reg_157 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem0_RVALID = ap_const_logic_0)));
    end process;


    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, input_r_empty_n, input_size_empty_n)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_size_empty_n = ap_const_logic_0) or (input_r_empty_n = ap_const_logic_0));
    end process;

        ap_block_state72_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state73_pp0_stage0_iter1_assign_proc : process(m_axi_gmem0_RVALID, icmp_ln159_1_reg_157)
    begin
                ap_block_state73_pp0_stage0_iter1 <= ((icmp_ln159_1_reg_157 = ap_const_lv1_0) and (m_axi_gmem0_RVALID = ap_const_logic_0));
    end process;


    ap_block_state74_pp0_stage0_iter2_assign_proc : process(input_stream_full_n, icmp_ln159_1_reg_157_pp0_iter1_reg)
    begin
                ap_block_state74_pp0_stage0_iter2 <= ((icmp_ln159_1_reg_157_pp0_iter1_reg = ap_const_lv1_0) and (input_stream_full_n = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state72_assign_proc : process(icmp_ln159_1_fu_126_p2)
    begin
        if ((icmp_ln159_1_fu_126_p2 = ap_const_lv1_1)) then 
    ...
    gmem0_blk_n_R_assign_proc : process(m_axi_gmem0_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln159_1_reg_157)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln159_1_reg_157 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    icmp_ln159_1_fu_126_p2 <= "1" when (i_reg_94 = trunc_ln159_reg_147) else "0";
    icmp_ln159_fu_105_p2 <= "1" when (signed(input_size_dout) > signed(ap_const_lv32_0)) else "0";
    ...
    input_r_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, input_r_empty_n, input_size_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_size_empty_n = ap_const_logic_0) or (input_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    input_size_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, input_r_empty_n, input_size_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_size_empty_n = ap_const_logic_0) or (input_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    input_stream_blk_n_assign_proc : process(input_stream_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln159_1_reg_157_pp0_iter1_reg)
    begin
        if (((icmp_ln159_1_reg_157_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    input_stream_din <= gmem0_addr_read_reg_161;

    input_stream_write_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln159_1_reg_157_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln159_1_reg_157_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_axi_gmem0_ARADDR <= gmem0_addr_reg_141;
    m_axi_gmem0_ARBURST <= ap_const_lv2_0;
    m_axi_gmem0_ARCACHE <= ap_const_lv4_0;
    m_axi_gmem0_ARID <= ap_const_lv1_0;
    m_axi_gmem0_ARLEN <= input_size_read_reg_131;
    ...
    m_axi_gmem0_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln159_1_reg_157, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln159_1_reg_157 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    trunc_ln159_fu_117_p1 <= input_size_read_reg_131(31 - 1 downto 0);
end behav;
