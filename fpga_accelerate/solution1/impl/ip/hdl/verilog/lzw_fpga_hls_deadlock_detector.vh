    ...
    reg ap_done_reg_0;// for module encoding_U0
    always @ (negedge reset or posedge clock) begin
        if (~reset) begin
            ap_done_reg_0 <= 'b0;
        end
        else begin
            ap_done_reg_0 <= encoding_U0.ap_done & ~encoding_U0.ap_continue;
        end
    end

    reg ap_done_reg_1;// for module store_output_U0
    always @ (negedge reset or posedge clock) begin
        if (~reset) begin
            ap_done_reg_1 <= 'b0;
        end
        else begin
            ap_done_reg_1 <= store_output_U0.ap_done & ~store_output_U0.ap_continue;
        end
    end

    reg ap_done_reg_2;// for module copy_output_code_U0
    always @ (negedge reset or posedge clock) begin
        if (~reset) begin
            ap_done_reg_2 <= 'b0;
        end
        else begin
            ap_done_reg_2 <= copy_output_code_U0.ap_done & ~copy_output_code_U0.ap_continue;
        end
    end

    reg ap_done_reg_3;// for module copy_output_U0
    always @ (negedge reset or posedge clock) begin
        if (~reset) begin
            ap_done_reg_3 <= 'b0;
        end
        else begin
            ap_done_reg_3 <= copy_output_U0.ap_done & ~copy_output_U0.ap_continue;
        end
    end

    reg ap_done_reg_4;// for module Block_split214_proc_U0
    always @ (negedge reset or posedge clock) begin
        if (~reset) begin
            ap_done_reg_4 <= 'b0;
        end
        else begin
            ap_done_reg_4 <= Block_split214_proc_U0.ap_done & ~Block_split214_proc_U0.ap_continue;
        end
    end

reg [15:0] trans_in_cnt_0;// for process lzw_fpga_entry11_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (lzw_fpga_entry11_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process lzw_fpga_entry11_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (lzw_fpga_entry11_U0.ap_done == 1'b1 && lzw_fpga_entry11_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_1;// for process encoding_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_1 <= 16'h0;
    end
    else if (encoding_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_1;// for process encoding_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_1 <= 16'h0;
    end
    else if (encoding_U0.ap_done == 1'b1 && encoding_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_2;// for process decoding_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_2 <= 16'h0;
    end
    else if (decoding_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_2;// for process decoding_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_2 <= 16'h0;
    end
    else if (decoding_U0.ap_done == 1'b1 && decoding_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_3;// for process store_output_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_in_cnt_3 <= 16'h0;
    end
    else if (store_output_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_3;// for process store_output_U0
always @(negedge reset or posedge clock) begin
    if (~reset) begin
         trans_out_cnt_3 <= 16'h0;
    end
    else if (store_output_U0.ap_done == 1'b1 && store_output_U0.ap_continue == 1'b1) begin
    ...
    // Process: lzw_fpga_entry11_U0
    lzw_fpga_hls_deadlock_detect_unit #(9, 0, 5, 5) lzw_fpga_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~lzw_fpga_entry11_U0.input_out_blk_n) | (~lzw_fpga_entry11_U0.input_size_out_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0;
    assign proc_0_TLF_FIFO_blk[0] = 1'b0;
    assign proc_0_input_sync_blk[0] = 1'b0 | (ap_sync_lzw_fpga_entry11_U0_ap_ready & lzw_fpga_entry11_U0.ap_idle & ~ap_sync_load_input_U0_ap_ready);
    assign proc_0_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_0[0] = dl_detect_out ? proc_dep_vld_vec_0_reg[0] : (proc_0_data_FIFO_blk[0] | proc_0_data_PIPO_blk[0] | proc_0_start_FIFO_blk[0] | proc_0_TLF_FIFO_blk[0] | proc_0_input_sync_blk[0] | proc_0_output_sync_blk[0]);
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~lzw_fpga_entry11_U0.input_size_out1_blk_n);
    assign proc_0_data_PIPO_blk[1] = 1'b0;
    assign proc_0_start_FIFO_blk[1] = 1'b0 | (~start_for_encoding_U0_U.if_full_n & lzw_fpga_entry11_U0.ap_start & ~lzw_fpga_entry11_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_encoding_U0_U.if_read);
    assign proc_0_TLF_FIFO_blk[1] = 1'b0;
    assign proc_0_input_sync_blk[1] = 1'b0;
    assign proc_0_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_0[1] = dl_detect_out ? proc_dep_vld_vec_0_reg[1] : (proc_0_data_FIFO_blk[1] | proc_0_data_PIPO_blk[1] | proc_0_start_FIFO_blk[1] | proc_0_TLF_FIFO_blk[1] | proc_0_input_sync_blk[1] | proc_0_output_sync_blk[1]);
    assign proc_0_data_FIFO_blk[2] = 1'b0 | (~lzw_fpga_entry11_U0.output_code_out_blk_n);
    ...
    assign proc_0_data_FIFO_blk[3] = 1'b0 | (~lzw_fpga_entry11_U0.output_size_out_blk_n) | (~lzw_fpga_entry11_U0.output_length_out_blk_n);
    ...
    assign proc_0_data_FIFO_blk[4] = 1'b0 | (~lzw_fpga_entry11_U0.output_out_blk_n);
    ...
    assign in_chan_dep_data_vec_0[26 : 18] = dep_chan_data_5_0;
    ...
    lzw_fpga_hls_deadlock_detect_unit #(9, 1, 2, 2) lzw_fpga_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~load_input_U0.input_stream_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~load_input_U0.input_r_blk_n) | (~load_input_U0.input_size_blk_n);
    assign proc_1_data_PIPO_blk[1] = 1'b0;
    assign proc_1_start_FIFO_blk[1] = 1'b0;
    assign proc_1_TLF_FIFO_blk[1] = 1'b0;
    assign proc_1_input_sync_blk[1] = 1'b0 | (ap_sync_load_input_U0_ap_ready & load_input_U0.ap_idle & ~ap_sync_lzw_fpga_entry11_U0_ap_ready);
    ...
    // Process: encoding_U0
    lzw_fpga_hls_deadlock_detect_unit #(9, 2, 4, 4) lzw_fpga_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~encoding_U0.input_stream_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~encoding_U0.code_stream_blk_n) | (~encoding_U0.local_output_size_out_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_decoding_U0_U.if_full_n & encoding_U0.ap_start & ~encoding_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_decoding_U0_U.if_read);
    assign proc_2_TLF_FIFO_blk[1] = 1'b0;
    assign proc_2_input_sync_blk[1] = 1'b0;
    assign proc_2_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_2[1] = dl_detect_out ? proc_dep_vld_vec_2_reg[1] : (proc_2_data_FIFO_blk[1] | proc_2_data_PIPO_blk[1] | proc_2_start_FIFO_blk[1] | proc_2_TLF_FIFO_blk[1] | proc_2_input_sync_blk[1] | proc_2_output_sync_blk[1]);
    assign proc_2_data_FIFO_blk[2] = 1'b0 | (~encoding_U0.input_size_blk_n);
    assign proc_2_data_PIPO_blk[2] = 1'b0;
    assign proc_2_start_FIFO_blk[2] = 1'b0 | (~start_for_encoding_U0_U.if_empty_n & encoding_U0.ap_idle & ~start_for_encoding_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[2] = 1'b0;
    assign proc_2_input_sync_blk[2] = 1'b0;
    assign proc_2_output_sync_blk[2] = 1'b0;
    assign proc_dep_vld_vec_2[2] = dl_detect_out ? proc_dep_vld_vec_2_reg[2] : (proc_2_data_FIFO_blk[2] | proc_2_data_PIPO_blk[2] | proc_2_start_FIFO_blk[2] | proc_2_TLF_FIFO_blk[2] | proc_2_input_sync_blk[2] | proc_2_output_sync_blk[2]);
    assign proc_2_data_FIFO_blk[3] = 1'b0 | (~encoding_U0.local_output_size_out1_blk_n);
    assign proc_2_data_PIPO_blk[3] = 1'b0 | (~local_output_code_U.i_full_n & encoding_U0.ap_done & ap_done_reg_0 & ~local_output_code_U.t_read);
    ...
    // Process: decoding_U0
    lzw_fpga_hls_deadlock_detect_unit #(9, 3, 3, 3) lzw_fpga_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~decoding_U0.code_stream_blk_n) | (~decoding_U0.local_output_size_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_decoding_U0_U.if_empty_n & decoding_U0.ap_idle & ~start_for_decoding_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~decoding_U0.output_stream_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0 | (~start_for_store_output_U0_U.if_full_n & decoding_U0.ap_start & ~decoding_U0.real_start & (trans_in_cnt_2 == trans_out_cnt_2) & ~start_for_store_output_U0_U.if_read);
    assign proc_3_TLF_FIFO_blk[1] = 1'b0;
    assign proc_3_input_sync_blk[1] = 1'b0;
    assign proc_3_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_3[1] = dl_detect_out ? proc_dep_vld_vec_3_reg[1] : (proc_3_data_FIFO_blk[1] | proc_3_data_PIPO_blk[1] | proc_3_start_FIFO_blk[1] | proc_3_TLF_FIFO_blk[1] | proc_3_input_sync_blk[1] | proc_3_output_sync_blk[1]);
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~decoding_U0.local_output_size_out_blk_n);
    ...
    lzw_fpga_hls_deadlock_detect_unit #(9, 4, 3, 3) lzw_fpga_hls_deadlock_detect_unit_4 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~store_output_U0.output_stream_blk_n);
    ...
    assign proc_4_data_PIPO_blk[1] = 1'b0 | (~local_output_U.i_full_n & store_output_U0.ap_done & ap_done_reg_1 & ~local_output_U.t_read);
    assign proc_4_start_FIFO_blk[1] = 1'b0;
    assign proc_4_TLF_FIFO_blk[1] = 1'b0;
    assign proc_4_input_sync_blk[1] = 1'b0;
    assign proc_4_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_4[1] = dl_detect_out ? proc_dep_vld_vec_4_reg[1] : (proc_4_data_FIFO_blk[1] | proc_4_data_PIPO_blk[1] | proc_4_start_FIFO_blk[1] | proc_4_TLF_FIFO_blk[1] | proc_4_input_sync_blk[1] | proc_4_output_sync_blk[1]);
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~store_output_U0.local_output_length_out_blk_n);
    assign proc_4_data_PIPO_blk[2] = 1'b0;
    assign proc_4_start_FIFO_blk[2] = 1'b0 | (~start_for_Block_split212_proc_U0_U.if_full_n & store_output_U0.ap_start & ~store_output_U0.real_start & (trans_in_cnt_3 == trans_out_cnt_3) & ~start_for_Block_split212_proc_U0_U.if_read);
    ...
    assign in_chan_dep_data_vec_4[17 : 9] = dep_chan_data_6_4;
    assign token_in_vec_4[1] = token_6_4;
    assign in_chan_dep_vld_vec_4[2] = dep_chan_vld_7_4;
    assign in_chan_dep_data_vec_4[26 : 18] = dep_chan_data_7_4;
    ...
    // Process: copy_output_code_U0
    lzw_fpga_hls_deadlock_detect_unit #(9, 5, 4, 4) lzw_fpga_hls_deadlock_detect_unit_5 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~copy_output_code_U0.local_output_size_blk_n);
    assign proc_5_data_PIPO_blk[0] = 1'b0 | (~local_output_code_U.t_empty_n & copy_output_code_U0.ap_idle & ~local_output_code_U.i_write);
    assign proc_5_start_FIFO_blk[0] = 1'b0;
    assign proc_5_TLF_FIFO_blk[0] = 1'b0;
    assign proc_5_input_sync_blk[0] = 1'b0;
    assign proc_5_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_5[0] = dl_detect_out ? proc_dep_vld_vec_5_reg[0] : (proc_5_data_FIFO_blk[0] | proc_5_data_PIPO_blk[0] | proc_5_start_FIFO_blk[0] | proc_5_TLF_FIFO_blk[0] | proc_5_input_sync_blk[0] | proc_5_output_sync_blk[0]);
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~copy_output_code_U0.output_code_blk_n);
    ...
    assign proc_5_output_sync_blk[2] = 1'b0 | (ap_done_reg_2 & copy_output_code_U0.ap_done & ~copy_output_U0.ap_done);
    ...
    assign proc_5_output_sync_blk[3] = 1'b0 | (ap_done_reg_2 & copy_output_code_U0.ap_done & ~Block_split214_proc_U0.ap_done);
    ...
    assign in_chan_dep_data_vec_5[26 : 18] = dep_chan_data_7_5;
    ...
    // Process: Block_split212_proc_U0
    lzw_fpga_hls_deadlock_detect_unit #(9, 6, 3, 1) lzw_fpga_hls_deadlock_detect_unit_6 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~Block_split212_proc_U0.local_output_length_blk_n);
    assign proc_6_data_PIPO_blk[0] = 1'b0;
    assign proc_6_start_FIFO_blk[0] = 1'b0 | (~start_for_Block_split212_proc_U0_U.if_empty_n & Block_split212_proc_U0.ap_idle & ~start_for_Block_split212_proc_U0_U.if_write);
    ...
    assign in_chan_dep_data_vec_6[26 : 18] = dep_chan_data_8_6;
    ...
    // Process: copy_output_U0
    lzw_fpga_hls_deadlock_detect_unit #(9, 7, 4, 5) lzw_fpga_hls_deadlock_detect_unit_7 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_7_data_PIPO_blk[0] = 1'b0 | (~local_output_U.t_empty_n & copy_output_U0.ap_idle & ~local_output_U.i_write);
    assign proc_7_start_FIFO_blk[0] = 1'b0;
    assign proc_7_TLF_FIFO_blk[0] = 1'b0;
    assign proc_7_input_sync_blk[0] = 1'b0;
    assign proc_7_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_7[0] = dl_detect_out ? proc_dep_vld_vec_7_reg[0] : (proc_7_data_FIFO_blk[0] | proc_7_data_PIPO_blk[0] | proc_7_start_FIFO_blk[0] | proc_7_TLF_FIFO_blk[0] | proc_7_input_sync_blk[0] | proc_7_output_sync_blk[0]);
    assign proc_7_data_FIFO_blk[1] = 1'b0 | (~copy_output_U0.output_r_blk_n);
    ...
    assign proc_7_TLF_FIFO_blk[2] = 1'b0 | (~local_output_length_load_loc_channel_U.if_empty_n & copy_output_U0.ap_idle & ~local_output_length_load_loc_channel_U.if_write);
    ...
    assign proc_7_output_sync_blk[3] = 1'b0 | (ap_done_reg_3 & copy_output_U0.ap_done & ~copy_output_code_U0.ap_done);
    ...
    assign proc_7_output_sync_blk[4] = 1'b0 | (ap_done_reg_3 & copy_output_U0.ap_done & ~Block_split214_proc_U0.ap_done);
    ...
    // Process: Block_split214_proc_U0
    lzw_fpga_hls_deadlock_detect_unit #(9, 8, 4, 5) lzw_fpga_hls_deadlock_detect_unit_8 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_8_data_FIFO_blk[0] = 1'b0 | (~Block_split214_proc_U0.output_size_blk_n) | (~Block_split214_proc_U0.output_length_blk_n);
    ...
    assign proc_8_data_FIFO_blk[1] = 1'b0 | (~Block_split214_proc_U0.local_output_size_blk_n);
    ...
    assign proc_8_TLF_FIFO_blk[2] = 1'b0 | (~local_output_length_load_cast_loc_channel_U.if_empty_n & Block_split214_proc_U0.ap_idle & ~local_output_length_load_cast_loc_channel_U.if_write);
    ...
    assign proc_8_output_sync_blk[3] = 1'b0 | (ap_done_reg_4 & Block_split214_proc_U0.ap_done & ~copy_output_code_U0.ap_done);
    ...
    assign proc_8_output_sync_blk[4] = 1'b0 | (ap_done_reg_4 & Block_split214_proc_U0.ap_done & ~copy_output_U0.ap_done);
    ...
    assign in_chan_dep_data_vec_8[17 : 9] = dep_chan_data_3_8;
    ...
    assign in_chan_dep_vld_vec_8[3] = dep_chan_vld_7_8;
    assign in_chan_dep_data_vec_8[35 : 27] = dep_chan_data_7_8;
    assign token_in_vec_8[3] = token_7_8;
    ...
    assign dep_chan_vld_8_7 = out_chan_dep_vld_vec_8[4];
    assign dep_chan_data_8_7 = out_chan_dep_data_8;
    assign token_8_7 = token_out_vec_8[4];


`include "lzw_fpga_hls_deadlock_report_unit.vh"
