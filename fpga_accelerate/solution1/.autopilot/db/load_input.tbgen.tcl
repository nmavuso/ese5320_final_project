...
set C_modelArgList {
	...
	{ input_stream int 8 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "input_stream", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ input_stream_din sc_out sc_lv 8 signal 1 } 
	{ input_stream_full_n sc_in sc_logic 1 signal 1 } 
	{ input_stream_write sc_out sc_logic 1 signal 1 } 
	{ input_r_dout sc_in sc_lv 64 signal 2 } 
	{ input_r_empty_n sc_in sc_logic 1 signal 2 } 
	{ input_r_read sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "input_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
