set moduleName Block_split214_proc
set isTopModule 0
...
set C_modelName {Block_.split214_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_size int 64 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "output_size", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_size_dout sc_in sc_lv 64 signal 0 } 
	{ output_size_empty_n sc_in sc_logic 1 signal 0 } 
	{ output_size_read sc_out sc_logic 1 signal 0 } 
	...
	{ output_length_dout sc_in sc_lv 64 signal 3 } 
	{ output_length_empty_n sc_in sc_logic 1 signal 3 } 
	{ output_length_read sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_size_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_size", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "output_size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "7", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "local_output_size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "local_output_size_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "output_length", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "7", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	output_size { ap_fifo {  { output_size_dout fifo_data 0 64 }  { output_size_empty_n fifo_status 0 1 }  { output_size_read fifo_update 1 1 } } }
