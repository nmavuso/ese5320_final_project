...
set id 15
set name lzw_fpga_mux_1632_8_1_1
...
set ID 21
set hasByteEnable 0
set MemName lzw_fpga_decoding_table_str_0
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_encoded_data \
    op interface \
    ports { encoded_data { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_encoded_size \
    op interface \
    ports { encoded_size { I 32 vector } } \
} "
}
